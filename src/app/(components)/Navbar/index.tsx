...
const Navbar = () => {
    ...
    return (
        <div className='flex justify-between items-center w-full mb-7 px-6'>
            {/* LEFT SIDE */}
            <div className='flex justify-between items-center gap-5 px-6'>
                ...
                <div className='relative'>
                    <input type='search' placeholder='Start to type to search groups & products' className='pl-10 pr-4 py-2 w-50 md:w-80 border-2 border-gray-300 bg-white rounded-lg focus:outline-none focus:border-blue-500' />
            ...
            <div className='flex justify-between items-center gap-5'>
                <div className='hidden md:flex justify-between items-center gap-5'>
                    ...
                    <div className='relative'>
                        ...
                        <span className='absolute -top-2 -right-2 inline-flex items-center justify-center px-[0.4rem] py-1 text-sm font-semibold leading-none text-red-100 bg-red-400 rounded-full'>5</span>
                    </div>
                    ...
                    <div className='flex items-center gap-3 cursor-pointer'>
                        ...
                        <span className='font-semibold'>Ike Odira</span>
                    </div>
                </div>
                <Link href="/settings">
