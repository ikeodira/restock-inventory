                ...
                <>
                    ...
                    <div>
                        ...
                        <ResponsiveContainer width="100%" height={350} className="px-7">
                            <BarChart data={salesData} margin={{ top: 0, right: 0, left: -25, bottom: 0 }}>
                                ...
                                <YAxis tick={{ fontSize: 12, dx: -1, }} tickLine={false} axisLine={false} tickFormatter={(value) => {
                    ...
                    <div>
                        ...
                        <div className='flex justify-between items-center mt-6 text-sm px-7 mb-4'>
                            <p>{salesData.length || 0} day(s)</p>
                            <p className='text-sm'>Highest Sales Date: <span className='font-bold'>{highestValueDate}</span></p>
                        </div>
                    </div>
                </>
            )}
