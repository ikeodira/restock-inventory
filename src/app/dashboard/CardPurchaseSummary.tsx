                ...
                <>
                    ...
                    <div>
                            ...
                            <div className='flex items-center'>
                                ...
                                {lastDataPoint && (
                                    <p className={`text-sm ${lastDataPoint.changePercentage! >= 0 ? "text-green-500" : "text-red-500"} flex ml-3`}>
                                        {lastDataPoint.changePercentage! >= 0 ? <TrendingUpIcon className='w-4 h-4' /> : <TrendingDownIcon className='w-4 h-4' />}
                        ...
                        <ResponsiveContainer width="100%" height={350} className="px-7">
                            <AreaChart data={purchasedData} margin={{ top: 0, right: 0, left: -50, bottom: 45 }}>
